...
//		handler.post(myRunnable);
	...
	public void setMessage(String msg,boolean luckyDraw) {
		if(luckyDraw)
			tvMsg.setTextSize(TypedValue.COMPLEX_UNIT_PX, c.getResources().getDimensionPixelSize(R.dimen.dimen_16));
		tvMsg.setText(msg);
	}

	public void setMessage(String msg,boolean luckyDraw,int dimens) {
		if(luckyDraw)
			tvMsg.setTextSize(TypedValue.COMPLEX_UNIT_PX, c.getResources().getDimensionPixelSize(R.dimen.dimen_16));
		tvMsg.setTextSize(TypedValue.COMPLEX_UNIT_PX, c.getResources().getDimensionPixelSize(dimens));
		tvMsg.setText(msg);
	}
